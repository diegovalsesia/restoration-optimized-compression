...
# this code is copied from https://github.com/megvii-research/NAFNet/blob/main/basicsr/models/archs/Baseline_arch.py
# ------------------------------------------------------------------------
...
from lidarDeblur.model.utils.arch_util import LayerNorm2d
